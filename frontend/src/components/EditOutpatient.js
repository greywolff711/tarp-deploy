                ...
                <form className="flex flex-col justify-center place-items-center" onSubmit={(e)=>onsubmit(e)}>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            placeholder={item.name+' '+item.last_name} name='name' onChange={(e)=>onchange(e)}/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 
                            mb-3 leading-tight focus:outline-none focus:border-gray-400 focus:bg-white" id="grid-email" type="text" placeholder={item.email} name='email' onChange={(e)=>onchange(e)}/>
                        </div>
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            placeholder={item.password} name='password' onChange={(e)=>onchange(e)}/>
                        </div> 
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            placeholder={item.age} name='age' onChange={(e)=>onchange(e)}/>
                        </div> 
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div className="w-full md:w-[30rem] px-3 mb-6 md:mb-0">
                        ...
                        placeholder={item.address} name='address' onChange={(e)=>onchange(e)}/>
                    </div>
