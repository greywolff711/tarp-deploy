            ...
            <div className="w-full px-6 py-6 mx-auto">
                ...
                <div className="flex-none w-full max-w-full px-3">
                    ...
                    <div className="p-2 pb-0 mb-0 bg-white border-1 border-b-solid rounded border-black">
                        <h6 className="text-2xl uppercase">Pharmacists</h6>
                        <br/>
                        <Link to={"/"+l+"/AddPharmacist"}  className="font-semibold leading-tight text-xs rounded border-black border-2 px-3 py-3 transition duration-300 hover:bg-black hover:text-white">ADD</Link>
                    </div>
                    <br/>
